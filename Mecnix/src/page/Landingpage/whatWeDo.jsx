      ...
      <section data-aos="fade-up" className="h-screen flex items-center justify-center md:mt-20 mt-60 bg-black">
        ...
        <div className='flex flex-row-reverse md:block'>
            ...
            <div>
              ...
              <img src={dot} className='block md:hidden h-28 w-40 md:-mt-20 md:ml-6 -ml-10 -mt-10'/>
            </div>
       </div>
          ...
          <div className="p-4 md:-mt-32">
            ...
            <div className="flex md:flex-row flex-col md:w-11/12 w-customWidth5">
            ...
            <div className="flex md:ml-20 md:w-10/12 md:flex-row flex-col  w-customWidth5">
      ...
      <section data-aos="fade-up" className="h-screen flex items-center justify-center bg-black md:mt-0 mt-96">
        <div>
          <div className='flex flex-row-reverse md:block'>
            ...
            <img src={dot} className='block md:hidden h-24 w-28 -ml-40 -mt-8'/>
          </div>
          <div>
