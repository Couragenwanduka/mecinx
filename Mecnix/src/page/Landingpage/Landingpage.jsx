...
const Landingpage = () => {
  ...
  return (
    <div className='overflow-x-hidden' id='home'>
      <NavigationBar />
      <div className="absolute inset-0 flex items-center justify-center md:-mt-16 -mt-72 md:ml-96">
        <img src={Cube} className="md:h-4/6 h-2/6 z-30 md:ml-48 ml-14" alt="Cube" />
      </div>

      <div className="absolute text-white  md:-mt-60 -mt-80 font-Saira md:ml-20 ml-8">
        <h1 className="md:text-7xl text-4xl font-bold">Reach</h1>
      ...
      <div className="absolute text-white md:ml-6 ml-4">
        <p className="md:text-4xl text-xl font-bold font-Saira md:ml-14 md:mt-32">
        ...
        <span className="flex md:ml-16 mt-10 border-t border-gray-600 mr-20 justify-between">
          <img src={Binance} className="h-8 mt-5 hidden md:block" alt="Binance" />
        ...
        <CarouselForMobile slides={images} interval={3000} />
        </div>
        <div className="flex flex-col md:flex-row md:w-customWidth2 w-customWidth6 border border-gray-600 md:ml-14 -ml-3 mt-28 rounded-2xl bg-black">
          ...
          <span className="md:w-1/2 bg-white bg-opacity-5 backdrop-filter backdrop-blur-sm font-Saira rounded-r-3xl">
            <h1 className="text-white font-extrabold text-4xl md:mt-28 mt-10 md:ml-20 ml-9">We connect</h1>
            <p className="break-words md:w-9/12 w-11/12 md:ml-20 ml-9 mt-3 text-lg md:mb-0 mb-10">
          ...
          <div>
            <div className='absolute bg-black w-6/12 h-96 flex'>
              <div className='bg-black'>
                ...
                <img src={twitter} className='md:ml-16 mt-10 h-10 md:w-full w-9/12 ml-2'/>
