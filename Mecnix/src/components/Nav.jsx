    ...
    return (
        <div className=" w-full h-screen overflow-hidden ">
            ...
            <div className="absolute  flex flex-row items-center justify-around text-white">
                ...
                <nav className="z-40">
                <ul className="flex space-x-8 bg-white bg-opacity-5 backdrop-filter backdrop-blur-sm text-Saira text-sm rounded-2xl border-gray-600 border p-4 w-6/12 ml-96 mt-3">
